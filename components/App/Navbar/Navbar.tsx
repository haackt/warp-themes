...
function AppNavbar() {
	...
	return (
		<nav className='fixed flex flex-row items-center justify-between w-full py-3 pl-4 pr-2 bg-white border-b'>
			...
			<div className='flex flex-row gap-2'>
				...
				<AppDialogSettings _open={isSettingsOpen} _onClose={() => setIsSettingsOpen(false)} />
				...
				<Popover>
					...
					>
						...
						>
							...
							<li>
								<button onClick={() => setIsSettingsOpen(true)} className='text-sm'>
							...
							<li>
								<a
									...
									className='text-sm'
								>
									<LightningBoltIcon className='inline w-6 h-6' />
									VS-Code Extension
							...
							<li>
								<a href='https://www.warp.dev/' target='_blank' rel='noopener noreferrer'>
									<TerminalIcon className='inline w-6 h-6' />
									Warp
									<ExternalLinkIcon className='w-4 h-4 ml-auto' />
								</a>
							</li>
							<li>
								<a href='https://www.github.com/haackt/warp-themes' target='_blank' rel='noopener noreferrer'>
									<CodeIcon className='inline w-6 h-6' />
									GitHub
									<ExternalLinkIcon className='w-4 h-4 ml-auto' />
								</a>
							</li>
							<li>
								<a href='https://github.com/sponsors/haackt' target='_blank' rel='noopener noreferrer'>
									<CashIcon className='inline w-6 h-6' />
									Donate
									<ExternalLinkIcon className='w-4 h-4 ml-auto' />
								</a>
							</li>
